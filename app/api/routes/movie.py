...
from app.schemas.movie import MovieCreate, MovieUpdate, MovieRead, MovieFilterParams
...
def list_movies(filters: MovieFilterParams = Depends(), service: MovieService = Depends(get_movie_service)):
